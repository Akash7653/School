        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-white/60 via-white to-white/70 dark:bg-slate-900 rounded-3xl shadow-2xl p-10 mb-8 relative overflow-hidden">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-['Playfair_Display'] text-slate-900 dark:text-white mb-2">Welcome Back</h1>
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-3">Sign in to your account</p>
            </div>
          </div>

          {/* SIGN IN */}
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl p-8 mb-8">
            <h2 className="text-2xl font-bold font-['Playfair_Display'] text-slate-900 dark:text-white mb-8 text-center">Sign In</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg transition-transform transform hover:-translate-y-1">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">School Management</p>
                  </div>
                </div>
                <Button
                ...
                >
                  Sign In as Admin <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg transition-transform transform hover:-translate-y-1">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Teacher Portal</p>
                  </div>
                </div>
                <Button
                ...
                >
                  Sign In as Faculty <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg transition-transform transform hover:-translate-y-1">
                ...
                >
                  Sign In as Student <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg transition-transform transform hover:-translate-y-1">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Parent Portal</p>
                  </div>
                </div>
                <Button
                ...
                >
                  Sign In as Parent <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow p-6 text-center">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">New user?</h3>
                <Button
                  variant="ghost"
                  onClick={() => navigate('/auth/register')}
                  className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
                >
                  Go to register <ChevronRight className="h-4 w-4 ml-2" />
                </Button>
              </div>
