  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res && res.message) {
        ...
        toast.success('Parent registration successful! Logged in.');
      }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="relative hidden lg:block">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/90 to-teal-900/80 rounded-xl"></div>
            <div className="absolute inset-0 flex items-center justify-center text-white p-8">
              <div className="text-center">
                <Users className="h-12 w-12 md:h-16 md:w-16 mx-auto mb-4" />
                <h1 className="text-2xl md:text-3xl font-bold font-['Playfair_Display'] mb-2">Parent Registration</h1>
                <p className="text-lg md:text-xl text-emerald-100">Sadhana Memorial School</p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-6 md:p-8">
                <div className="flex items-center justify-center mb-6">
                  <Users className="h-10 w-10 md:h-12 md:w-12 text-emerald-600 dark:text-emerald-400 mr-3" />
                  <h2 className="text-xl md:text-2xl font-bold font-['Playfair_Display'] text-slate-900 dark:text-white">Parent Registration</h2>
                </div>
