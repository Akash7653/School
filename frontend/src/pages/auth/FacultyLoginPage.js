      ...
      <div className="relative hidden md:block">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white p-12">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold font-['Playfair_Display'] mb-2">Faculty Portal</h1>
            <p className="text-lg text-blue-100">Education Excellence Through Teaching</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-8">
            <div className="flex items-center justify-center mb-6">
              ...
              <h2 className="text-2xl font-bold font-['Playfair_Display'] text-slate-900 dark:text-white ml-3">Faculty Login</h2>
            </div>
